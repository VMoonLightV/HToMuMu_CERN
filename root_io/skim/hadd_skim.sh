# hadd Data_2022Combined_skim.root Data_2022EE_skim.root Data_2022_skim.root

# hadd DY_2022Combined_skim.root DY_2022EE_skim.root DY_2022_skim.root
# hadd EWK_2022Combined_skim.root EWK_2022EE_skim.root EWK_2022_skim.root
# hadd TT_2022Combined_skim.root TT_2022EE_skim.root TT_2022_skim.root
# hadd DiBoson_2022Combined_skim.root DiBoson_2022EE_skim.root DiBoson_2022_skim.root

# hadd ggH_2022Combined_skim.root ggH_2022EE_skim.root ggH_2022_skim.root
# hadd VBF_2022Combined_skim.root VBF_2022EE_skim.root VBF_2022_skim.root
# hadd ttH_2022Combined_skim.root ttH_2022EE_skim.root ttH_2022_skim.root


# hadd Data_2023Combined_skim.root Data_2023BPix_skim.root Data_2023_skim.root

# hadd DY_2023Combined_skim.root DY_2023BPix_skim.root DY_2023_skim.root
# hadd EWK_2023Combined_skim.root EWK_2023BPix_skim.root EWK_2023_skim.root 
# hadd TT_2023Combined_skim.root TT_2023BPix_skim.root TT_2023_skim.root 
# hadd DiBoson_2023Combined_skim.root DiBoson_2023BPix_skim.root DiBoson_2023_skim.root 

# hadd ggH_2023Combined_skim.root ggH_2023BPix_skim.root ggH_2023_skim.root 
# hadd VBF_2023Combined_skim.root VBF_2023BPix_skim.root VBF_2023_skim.root 
# hadd ttH_2023Combined_skim.root ttH_2023BPix_skim.root ttH_2023_skim.root 

# hadd Data_Combined_skim.root Data_2022EE_skim.root Data_2022_skim.root Data_2023BPix_skim.root Data_2023_skim.root Data_2024_skim.root

# hadd DY_Combined_skim.root DY_2022EE_skim.root DY_2022_skim.root DY_2023BPix_skim.root DY_2023_skim.root
# hadd EWK_Combined_skim.root EWK_2022EE_skim.root EWK_2022_skim.root EWK_2023BPix_skim.root EWK_2023_skim.root 
# hadd TT_Combined_skim.root TT_2022EE_skim.root TT_2022_skim.root TT_2023BPix_skim.root TT_2023_skim.root 
# hadd DiBoson_Combined_skim.root DiBoson_2022EE_skim.root DiBoson_2022_skim.root DiBoson_2023BPix_skim.root DiBoson_2023_skim.root 

# hadd ggH_Combined_skim.root ggH_2022EE_skim.root ggH_2022_skim.root ggH_2023BPix_skim.root ggH_2023_skim.root 
# hadd VBF_Combined_skim.root VBF_2022EE_skim.root VBF_2022_skim.root VBF_2023BPix_skim.root VBF_2023_skim.root 
# hadd ttH_Combined_skim.root ttH_2022EE_skim.root ttH_2022_skim.root ttH_2023BPix_skim.root ttH_2023_skim.root 
