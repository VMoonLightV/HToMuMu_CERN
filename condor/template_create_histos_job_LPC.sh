...
################################################################
echo ${output_folder}
xrdcp -f ${channel}_${era}_histos.root root://cmseos.fnal.gov/${output_folder}
echo "Output file saved in root://cmseos.fnal.gov/${output_folder}${channel}_${era}_histos.root"
rm ${channel}_${era}_histos.root
