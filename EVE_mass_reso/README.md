...
6. Finally, we can check the $\sigma/\mu$ distribution in the ZCR and SR to see the performance of calibration. You can change the mass window for ZCR or SR in plot_macros/utils/sim_vs_data_general.py under condition **cali_draw**.
    ```
    python3 ./plot_macrosplot_sim_vs_data_general.py nobin EVE_resolution_calibrated_all_channel
