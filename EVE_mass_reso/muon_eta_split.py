            ...
            for region_1, eta_range_1 in eta_cuts.items():
                for region_2, eta_range_2 in eta_cuts.items():
                    ...
                    cuts = (
                        ...
                        & (branches["mu1_pt"] > muon1_pt_cuts[i])
                        & (branches["mu1_pt"] < muon1_pt_cuts[i+1])
                    ...
                    print(f"[Info] Final events in {category_name}: {len(selected_events['diMuon_mass'])}")
...
if __name__ == "__main__":
    ...
    base_input_directory = "/eos/home-y/yulou/Fnal-hmm/hmm-tuples/njet_test/nobin_jet/ZCR/"    
    output_directory = "/eos/home-y/yulou/Fnal-hmm/hmm-tuples/EVE_pt_eta/ZCR_75-105/"
    os.makedirs(output_directory, exist_ok=True)

    for era in eras:
        input_file_name = base_input_directory  + "Data_" + era + "_skim.root"
        ...
        for dataset in signal_datasets:
            input_file_name = base_input_directory + dataset + "_" + era + "_skim.root"
