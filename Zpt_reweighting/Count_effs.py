...
def draw_data_and_simul_and_ratio(
    ...
    # without muon eff
    noeff_dir = "/eos/home-y/yulou/Fnal-hmm/hmm-tuples/njet/nobin_jet/ZCR/"
    ...
    # with muon eff
    eff_dir = "/eos/home-y/yulou/Fnal-hmm/hmm-tuples/njet/nobin_jet/eff_ZCR/"
    ...
    if (variable == "diMuon_pt"): bkg_bins_list_eff = np.linspace(x_range[variable_bin][0],x_range[variable_bin][1], n_bins[variable_bin]+1)
    hep.histplot(
        bkg_histograms_list_eff,
        bkg_bins_list_eff,
        yerr=True,
        histtype="errorbar",
        label="eff_MC",
    ...
    axs[0].set_ylim(0.1, 1000 * np.max(bkg_histograms_list_eff))
    ...
    if "ZCR" in region:
        ...
        with open(csv_path, 'a', newline='') as csvfile:
            ...
            csv_writer.writerow([era, njet, variable, region, sum_MC_eff, sum_MC_noeff, DY_count, sum_MC_eff/sum_MC_noeff, 
                                 sum_MC_noeff - DY_count, sum_MC_eff - sum_MC_noeff + DY_count, (sum_MC_eff - sum_MC_noeff + DY_count)/DY_count])
