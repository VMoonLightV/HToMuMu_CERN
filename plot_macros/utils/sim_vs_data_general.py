    ...
    for source in sources:
        with ur.open(input_dir + source + "_" + era + "_skim.root:tree_output") as file:
            ...
            if cali_draw == True:
                ...
                ### you can add a mass window cut here
                ...
                print("Here we draw calibrated/relative_diMuon_bsConstrainedMass_error plot")
            else:
                if (
...
def draw_data_and_simul_and_ratio(
    ...
    if "ZCR" in region:
        ...
        if njet == "nobin_":
            csv_path = f"../scripts/event_counts_{region}_nobin.csv"
        else:
            csv_path = f"../scripts/event_counts_{region}_bin.csv"
