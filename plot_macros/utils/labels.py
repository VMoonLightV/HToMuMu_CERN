...
x_labels = {
    ...
    "diMuon_mass_Z": r"$m_{\mu\mu}$ [GeV]",
    "diMuon_bsConstrainedMass": r"$m_{\mu\mu,BSC}$ [GeV]",
    "diMuon_bsConstrainedMass_Z": r"$m_{\mu\mu,BSC}$ [GeV]",
    ...
    "calibrated_diMuon_bsConstrainedMass_error": r"$cali \sigma_{\mu\mu}/M_{\mu\mu} (BSC)$",
    "relative_diMuon_bsConstrainedMass_sigma": r"$\sigma_{\mu\mu} (BSC)$",
    "calibrated_diMuon_bsConstrainedMass_sigma": r"$cali \sigma_{\mu\mu} (BSC)$",
    ## Muon variables
...
n_bins = {
    ...
    "relative_diMuon_bsConstrainedMass_error": 80,
    "calibrated_diMuon_bsConstrainedMass_error": 80,
    "relative_diMuon_bsConstrainedMass_sigma": 80,
    "calibrated_diMuon_bsConstrainedMass_sigma": 80,
    ## Muon variables
...
x_range = {
    ...
    "relative_diMuon_bsConstrainedMass_error": (0, 0.05),
    "calibrated_diMuon_bsConstrainedMass_error": (0, 0.05),
    "relative_diMuon_bsConstrainedMass_sigma": (0, 5),
    "calibrated_diMuon_bsConstrainedMass_sigma": (0, 5),
    ## Muon variables
