...
def copy_and_skim_tree(
    tuple_path, tuple_name, BDT_path, BDT_name, channel_US, use_bsConstrain
):
    ...
    if use_bsConstrain:
        cuts = (
            "diMuon_bsConstrainedMass > 100 && diMuon_bsConstrainedMass < 180 && is_"
            + channel_US
            + "_category == 1"
        )
    else:
        cuts = (
            "diMuon_mass > 100 && diMuon_mass < 180 && is_"
            + channel_US
            + "_category == 1"
        )
    ...
    if use_bsConstrain:
        ...
        """
            [
                ...
                "relative_diMuon_bsConstrainedMass_error",
                r"rela $\sigma_{m_{\mu\mu}}/m_{\mu\mu}$",
            ],
            """
    else:
        channel_vars += [
    ...
    if use_bsConstrain:
        channel_vars += [
            ...
            [
                ...
                "calibrate_diMuon_bsConstrainedMass_error",
                "calibrate_diMuon_bsConstrainedMass_error",
            ],
        ...
        channel_vars += [
            ["diMuon_mass", "diMuon_mass", "diMuon_mass"],
            [
